...
public class BaseClass {
	...
	
	{
		...
		// for selenium grid remote envirment launching
		if(p.getProperty("execution_env").equalsIgnoreCase("remote"))
		{
			...
			driver=new RemoteWebDriver(new URL("http://192.168.150.250:4444/wd/hub"),capabilities);
		}
		...
		/*
		 * //launching browser based on condition on local switch(br.toLowerCase()) {
